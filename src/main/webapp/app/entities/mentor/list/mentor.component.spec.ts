...
import { sampleWithRequiredData } from '../mentor.test-samples';
...
describe('Mentor Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.mentors()[0]).toEqual(expect.objectContaining({ id: 15712 }));
  });

  describe('trackId', () => {
    it('Should forward to mentorService', () => {
      const entity = { id: 15712 };
      jest.spyOn(service, 'getMentorIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMentorIdentifier).toHaveBeenCalledWith(entity);
